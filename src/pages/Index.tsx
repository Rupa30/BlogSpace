        ...
        <div ref={heroRef} className="container mx-auto px-6 lg:px-8">
          <div className="min-h-screen flex items-center justify-between pt-20">
            ...
            <div className="flex-1 max-w-3xl relative z-10">
              ...
              <h1
                ref={titleRef}
                className="text-6xl lg:text-8xl py-4 font-bold leading-none mb-8 bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 dark:from-white dark:via-blue-200 dark:to-purple-200 bg-clip-text text-transparent"
              >
                Stories
                <br />
              ...
              <p
                ref={subtitleRef}
                className="text-lg lg:text-xl text-gray-600 dark:text-gray-300 mb-12 leading-relaxed max-w-2xl"
              >
